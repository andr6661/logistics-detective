        ...
        <div style={{
            ...
            <div style={{
                ...
                <p style={{
                    ...
                    Получатель (ФрешМаркет) сообщил , что <strong style={{ color: '#facc15' }}>75% фруктов испортились</strong>.<br/>
                    Выставлена претензия на <strong style={{ color: '#facc15' }}>100 000 ₽</strong>
                </p>
